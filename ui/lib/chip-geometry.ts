 ...
 */
export const FRAME = { outer: 2.5, inner: 2.12, top: 0.0, depth: 0.22, explodeY: -0.6 };
export const BOARD = { size: 2.16, top: -0.04, thickness: 0.05, explodeY: -0.3 };
export const PLATE = { size: 1.93, window: 1.16, top: 0.03, depth: 0.07, explodeY: 0.55 };
export const CHIP = { size: 1.08, thickness: 0.04, explodeY: -0.1 };
export const GROUND = { size: 1.08, explodeY: 0.2 };
export const PADS = { width: 0.2, depth: 0.3, height: 0.012, offsetX: 0.14, explodeY: 0.34 };
export const JUNCTION = { explodeY: 0.5 };
export const GATE = { from: -0.44, to: -0.27, explodeY: 0.34 };
 ...
 */
export const ANCHORS: Record<PartId, { point: [number, number, number]; explodeY: number }> = {
  ...
  gate: { point: [-0.38, 0.01, 0], explodeY: GATE.explodeY },
