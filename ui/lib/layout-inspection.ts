...
export const INSPECTIONS: Record<PartId, { title: string; action: string; explanation: string; region: [number,number,number,number]; labels: InspectionLabel[] }> = {
  ...
  ground:{title:'Ground metal detail',action:'Inspect ground metal',region:[450,245,430,285],explanation:'The hatched region is ground metal. Its shaped opening reveals substrate around the electrodes, not a hole through the chip.',labels:[
