  ...
  return (
    <div className="insp-section design-lab">
      ...
      <section className="design-goals" aria-labelledby="design-goals-title">
        ...
        <div className="goal-card goal-card-featured">
      ...
      <details className="tech experiment-card">
        ...
        <div className="body">
          ...
          <label className="scenario-field"><span>Possible variation <strong><MathText math={`\\pm ${variation}\\,\\%`} /></strong></span><input type="range" min="0.1" max="20" step="0.1" value={variation} onChange={(e) => { setVariation(Number(e.target.value)); setStress(null); }} /></label>
      ...
      <details className="tech experiment-card">
        ...
        <div className="body">
          ...
          <label className="scenario-field"><span>Magnetic flux <strong><MathText math={`${num(flux, 2)}\\,\\Phi/\\Phi_0`} /></strong></span><input type="range" min="0" max="1" step="0.01" value={flux} onChange={(e) => { setFlux(Number(e.target.value)); setTunable(null); }} /></label>
          <label className="scenario-field"><span>Difference between junctions <strong><MathText math={`${num(asymmetry * 100, 0)}\\,\\%`} /></strong></span><input type="range" min="0" max="1" step="0.01" value={asymmetry} onChange={(e) => { setAsymmetry(Number(e.target.value)); setTunable(null); }} /></label>
